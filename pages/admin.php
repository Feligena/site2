...
<div class="row">
    ...
    <?php
        ...
        $sel='SELECT ci.id, ci.city, ho.id, ho.hotel, ho.cityid,
                    ho.countryid, ho.stars, ho.info, co.id, co.country
    ...
    ?>
            ...
            <br>
            <input type="submit" name="addhotel" value="Add" class="btn btn-sm btn-info">
            <input type="submit" name="delhotel" value="Delete" class="btn btn-sm btn-warning">
        </form>
    <?php
        mysqli_free_result($res);
    ...
    <!-- section D: for form Images -->
        ...
        ?>
                ...
                <input type="submit" name="addimage" value="Add" class="btn btn-sm btn-info">
            </select>
        </form>
        <?php
